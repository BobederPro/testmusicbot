...
module.exports = async (client) => {
    ...
    client.on("ready", async () => {
      try {
        await client.application.commands
          ...
          .then((s) => {
            console.log("Erfolgreich alle (/) Commands geladen.");
          })
          .catch((e) => {
            console.log(e);
          });
  ...
  client.queueEmed = new MessageEmbed()
    .setColor("RANDOM")
    .setTitle(`Keine Lieder in der Wiedergabeliste`);

  client.playembed = new MessageEmbed()
    .setColor("RANDOM")
    .setTitle(`Du musst einem Voicechannel joinen um Musik zu spielen`)
    .setImage(
    ...
    .setDescription(
      `>>> ** Ich spiele Lieder von Youtube , Spotify , Soundclound und vielen mehr... **`
    );
    ...
    msg.edit({
      embeds: [
        new MessageEmbed()
          ...
          .setFooter({
            text: `Angefordert von ${song.user.tag}`,
  ...
  client.updatequeuemsg = async function (queue) {
    ...
    msg.edit({
      embeds: [
        new MessageEmbed()
          .setColor("RANDOM")
          .setTitle(`${queue.songs.length} Lieder in der Wiedergabeliste`)
