...
module.exports = new Command({
  name: "autoplay",
  description: `Autoplay aktivieren/deaktivieren`,
  ...
  run: async ({ client, interaction, args, prefix }) => {
    ...
    if (!channel) {
      ...
      if (mode === true) {
        interaction.followUp(`** ${emoji.SUCCESS} AutoPlay aktiviert**`);
      } else {
        interaction.followUp(`** ${emoji.ERROR} AutoPlay deaktiviert **`);
      }
    }
  },
});
